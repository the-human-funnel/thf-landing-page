...
const footerLinks = {
  product: [
    ...
    { name: "How It Works", href: "https://github.com/the-human-funnel/the-human-funnel" },
  ...
  resources: [
    { name: "Documentation", href: "https://github.com/orgs/the-human-funnel/repositories" },
  ],
}
  ...
  return (
    <footer className="border-t border-border/50 bg-muted/30 py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-12 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              <Link
                href="https://twitter.com/Harshit_srv204"
                aria-label="Twitter"
                target="_blank"
              ...
              <Link
                href="https://www.linkedin.com/in/aditya-ghai/"
                aria-label="LinkedIn"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground transition-colors hover:text-primary"
        ...
        {/* Bottom Bar */}
        <div className="mt-12 flex flex-col items-center justify-center gap-4 border-t border-border/50 pt-8 text-sm text-muted-foreground">
